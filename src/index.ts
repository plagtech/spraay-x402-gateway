  ...
  const endpoints = [
    ...
    { method: "post", path: "/api/v1/batch/execute", price: "$0.02", priceNum: "0.020000", tag: "payments", desc: "Batch USDC payments on Base",
      ...
      outputProps: {
        ...
        batch: { type: "object", properties: { recipientCount: { type: "number" }, totalAmount: { type: "string" }, fee: { type: "string" }, feePercent: { type: "string" }, totalWithFee: { type: "string" } } },
        transaction: { type: "object", properties: { to: { type: "string" }, data: { type: "string" }, value: { type: "string" }, chainId: { type: "number" }, gasLimit: { type: "string" } } },
        approvalRequired: { type: "object", properties: { token: { type: "string" }, spender: { type: "string" }, amount: { type: "string" }, amountFormatted: { type: "string" } } },
      } },
    { method: "post", path: "/api/v1/batch/estimate", price: "$0.001", priceNum: "0.001000", tag: "payments", desc: "Estimate batch gas",
      inputProps: { token: { type: "string" }, recipients: { type: "array" }, amounts: { type: "array" }, sender: { type: "string" }, recipientCount: { type: "number" } },
      outputProps: {
        success: { type: "boolean" },
        token: { type: "object", properties: { symbol: { type: "string" }, address: { type: "string" }, decimals: { type: "number" }, isETH: { type: "boolean" } } },
