...
app.get("/.well-known/mcp/server-card.json", (_req, res) => {
  res.json({
    ...
    tools: [
      ...
      { name: "spraay_batch_execute", description: "Batch pay up to 200 recipients", price: "$0.01" },
      { name: "spraay_batch_estimate", description: "Estimate batch gas", price: "$0.001" },
      { name: "spraay_swap_quote", description: "Uniswap V3 swap quote", price: "$0.002" },
      { name: "spraay_swap_tokens", description: "List swap tokens", price: "$0.001" },
      { name: "spraay_swap_execute", description: "Execute swap", price: "$0.01" },
      { name: "spraay_oracle_prices", description: "On-chain token prices", price: "$0.003" },
      { name: "spraay_oracle_gas", description: "Gas prices", price: "$0.001" },
      { name: "spraay_oracle_fx", description: "Stablecoin FX rates", price: "$0.002" },
      { name: "spraay_bridge_quote", description: "Cross-chain bridge quote", price: "$0.005" },
      { name: "spraay_bridge_chains", description: "Supported bridge chains", price: "$0.001" },
      { name: "spraay_payroll_execute", description: "Execute payroll", price: "$0.02" },
      { name: "spraay_payroll_estimate", description: "Estimate payroll", price: "$0.002" },
      { name: "spraay_payroll_tokens", description: "Payroll stablecoins", price: "$0.001" },
      { name: "spraay_invoice_create", description: "Create invoice", price: "$0.005" },
      { name: "spraay_invoice_list", description: "List invoices", price: "$0.002" },
      { name: "spraay_invoice_get", description: "Invoice lookup", price: "$0.001" },
      { name: "spraay_analytics_wallet", description: "Wallet profile", price: "$0.005" },
      { name: "spraay_analytics_txhistory", description: "Tx history", price: "$0.003" },
      { name: "spraay_escrow_create", description: "Create escrow", price: "$0.008" },
      { name: "spraay_escrow_list", description: "List escrows", price: "$0.002" },
      { name: "spraay_escrow_get", description: "Escrow status", price: "$0.001" },
      { name: "spraay_escrow_fund", description: "Fund escrow", price: "$0.002" },
      { name: "spraay_escrow_release", description: "Release escrow", price: "$0.005" },
      { name: "spraay_escrow_cancel", description: "Cancel escrow", price: "$0.002" },
      { name: "spraay_classify_address", description: "AI wallet classification", price: "$0.008" },
      { name: "spraay_classify_tx", description: "AI tx classification", price: "$0.008" },
      { name: "spraay_explain_contract", description: "AI contract analysis", price: "$0.01" },
      { name: "spraay_summarize", description: "AI intelligence briefing", price: "$0.008" },
      { name: "spraay_notify_email", description: "Send email", price: "$0.003" },
      { name: "spraay_notify_sms", description: "Send SMS", price: "$0.005" },
      { name: "spraay_notify_status", description: "Notification status", price: "$0.001" },
      { name: "spraay_webhook_register", description: "Register webhook", price: "$0.003" },
      { name: "spraay_webhook_test", description: "Test webhook", price: "$0.002" },
      { name: "spraay_webhook_list", description: "List webhooks", price: "$0.001" },
      { name: "spraay_webhook_delete", description: "Delete webhook", price: "$0.001" },
      { name: "spraay_xmtp_send", description: "Send XMTP message", price: "$0.003" },
      { name: "spraay_xmtp_inbox", description: "XMTP inbox", price: "$0.002" },
      ...
      { name: "spraay_storage_pin", description: "Pin to IPFS/Arweave", price: "$0.005" },
      { name: "spraay_storage_get", description: "Get pinned content", price: "$0.002" },
      { name: "spraay_storage_status", description: "Pin status", price: "$0.001" },
      { name: "spraay_cron_create", description: "Create scheduled job", price: "$0.005" },
      { name: "spraay_cron_list", description: "List jobs", price: "$0.001" },
      { name: "spraay_cron_cancel", description: "Cancel job", price: "$0.001" },
      { name: "spraay_logs_ingest", description: "Ingest logs", price: "$0.001" },
      { name: "spraay_logs_query", description: "Query logs", price: "$0.003" },
      { name: "spraay_kyc_verify", description: "KYC verification", price: "$0.05" },
      { name: "spraay_kyc_status", description: "KYC status", price: "$0.005" },
      { name: "spraay_auth_session", description: "Create auth session", price: "$0.005" },
      { name: "spraay_auth_verify", description: "Verify token", price: "$0.001" },
      { name: "spraay_audit_log", description: "Record audit entry", price: "$0.001" },
      { name: "spraay_audit_query", description: "Query audit trail", price: "$0.005" },
      { name: "spraay_tax_calculate", description: "Tax gain/loss calc", price: "$0.01" },
      { name: "spraay_tax_report", description: "Tax report", price: "$0.02" },
